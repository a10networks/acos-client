...
# To use this, make an instance of Multipart and add parts to it via the
# factory methods field and file.  When you are done, get the content via
# the get method.
...
class Part(object):
    ...
    def __init__(self, name, filename, body, headers):
        # '''
        # Make a new part.  The part will have the given headers added
        # initially.
