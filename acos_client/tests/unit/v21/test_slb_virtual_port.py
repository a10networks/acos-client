...
CREATE_URL = '{}slb.virtual_server.vport.create&session_id={}'.format(BASE_URL, 'foobar')
DELETE_URL = '{}slb.virtual_server.vport.delete&session_id={}'.format(BASE_URL, 'foobar')
